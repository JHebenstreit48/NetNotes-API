...
A host needs an IPv4 address to participate on the internet and almost all LANs today. The IPv4 address is a logical network address that identifies a particular host.  
...
<div class="centeredBullet">
  <ul class="diamondBullets fullWidthBullet">
    <li>Each octet ranges from <span class="emphasis">0</span> to <span class="emphasis">255</span></li>
    <li><span class="emphasis">Four octets</span> together form a <span class="emphasis">32-bit address</span></li>
  </ul>
</div>
...
For this reason, the 32 bits are grouped into <span class="emphasis">four 8-bit bytes</span> called <span class="emphasis">octets</span> like this:

```shell
11010001.10100101.11001000.00000001
```

Each octet is converted to its decimal value, separated by a decimal point or period.  
...
<div class="centeredBullet">
  <ul class="diamondBullets fullWidthBullet">
    <li><span class="emphasis">Network portion</span>, identifies the <span class="emphasis">network</span></li>
    <li><span class="emphasis">Host portion</span>, identifies the <span class="emphasis">device</span> on that <span class="secondEmphasis">network</span></li>
  </ul>
</div>
...
<div class="xrefBox">
  ...
  <a href="/glossary/networking/tcpipmodel/internet/ipv4-and-ipv6-addressing" target="_blank" rel="noopener noreferrer">Glossary → IPv4 & IPv6 Addressing → Hierarchical Addressing</a>
</div>

Multiple logical networks can exist on one physical network if hosts have different network portions.  

For example, three hosts on the same physical LAN might have 192.168.18.x addresses while three others have 192.168.5.x addresses.  

Hosts with the same network portion can communicate directly, but hosts with different network portions need routing.
...
For the full ipconfig command reference, see the link below.
