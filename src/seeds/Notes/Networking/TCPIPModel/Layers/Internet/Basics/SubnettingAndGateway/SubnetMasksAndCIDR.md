...
<div class="xrefNav">
  ...
  <div class="xrefItem">
    <a class="xrefBtn" href="/tcpip-model/layers/internet/basics/subnetting-and-gateways/default-gateway-and-routing-tables">Next →</a>
    <div class="xrefTitle">Internet Layer - Subnetting & Gateways - Default Gateway & Routing Tables</div>
  </div>
</div>