...
<div class="centeredBullet">
  <ul class="diamondBullets fullWidthBullet">
    <li>The TCP/IP <span class="emphasis">Network Access layer</span> does not formally define electrical signaling standards</li>
    <li>It does not specify media encoding methods</li>
    <li>It assumes lower-level technologies handle transmission details</li>
  </ul>
</div>
...
<div class="centeredBullet">
  <ul class="diamondBullets fullWidthBullet">
    <li><span class="emphasis">Layer 1 (Physical)</span> explains how bits are transmitted over wire, fiber, or air</li>
    <li><span class="emphasis">Layer 2 (Data Link)</span> explains framing and local delivery</li>
  </ul>
</div>
