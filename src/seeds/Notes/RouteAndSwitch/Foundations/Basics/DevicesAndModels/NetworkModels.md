...
<table class="notesTable">
  ...
  <tbody>
    <tr class="tableRow">
      <td class="tableCell">Home Network</td>
      <td class="tableCell">Small scale, few devices, often combined router/AP/modem</td>
    </tr>
    <tr class="tableRow">
      <td class="tableCell">Enterprise Network</td>
      <td class="tableCell">Large scale, many devices, specialized hardware roles</td>
    </tr>
  </tbody>
</table>
...
<table class="notesTable">
  <thead>
    <tr class="tableHeader">
      <th class="tableCellHeader">Factor</th>
      <th class="tableCellHeader">Typical Difference</th>
    </tr>
  </thead>
  <tbody>
    <tr class="tableRow">
      <td class="tableCell">Traffic Volume</td>
      <td class="tableCell">Enterprise networks handle heavy, continuous traffic</td>
    </tr>
    <tr class="tableRow">
      <td class="tableCell">Security Needs</td>
      <td class="tableCell">Enterprises require advanced filtering and segmentation</td>
    </tr>
  </tbody>
</table>
...
<div class="xrefNav">
  ...
  <div class="xrefItem">
    <a class="xrefBtn" href="/legacy/osi-model/basics/fundamentals/introduction">Next →</a>
    <div class="xrefTitle">Next Topic: OSI Model Fundamentals → Introduction</div>
  </div>
</div>